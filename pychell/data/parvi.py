...
sigma_coeffs_fiber1 = np.array([np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       ...
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00]),
       np.array([2.68986911e-07, -0.000221371834, 1.62048242], dtype=object),
       np.array([4.30803466e-07, -0.000523453972, 1.80873237], dtype=object),
       np.array([2.40330465e-07, -0.000145705064, 1.58855819], dtype=object),
       np.array([9.93724618e-08, 2.14636269e-07, 1.54056591], dtype=object),
       np.array([9.44650308e-08, 8.2771189e-05, 1.38450065], dtype=object),
       np.array([1.1560074e-07, 4.54628824e-05, 1.39736087], dtype=object),
       np.array([1.36218329e-07, -2.32376282e-05, 1.45646093], dtype=object),
       np.array([9.64764365e-08, 4.00637684e-05, 1.45665065], dtype=object),
       np.array([1.44658611e-07, -4.50053231e-05, 1.51113069], dtype=object),
       np.array([1.86751631e-07, -0.000130896401, 1.57755831], dtype=object),
       np.array([1.98540651e-07, -0.000170679654, 1.61689634], dtype=object),
       np.array([1.3343797e-07, -5.08106218e-05, 1.5847543], dtype=object),
       np.array([1.49913021e-07, -5.23376171e-05, 1.58238211], dtype=object),
       np.array([1.48372399e-07, -3.28201516e-05, 1.58576763], dtype=object),
       np.array([-1.05838425e-07, 0.000358495133, 1.61462805], dtype=object),
       np.array([8.98706817e-08, 6.58748299e-05, 1.60561977], dtype=object),
       np.array([7.65496907e-08, 7.58176285e-05, 1.61655196], dtype=object),
       np.array([1.26380376e-07, 2.50452835e-06, 1.67152882], dtype=object),
       np.array([9.13719087e-08, 7.03549281e-05, 1.70532144], dtype=object),
       np.array([1.24374285e-07, 2.69856939e-05, 1.84015864], dtype=object),
       np.array([1.38580861e-07, 1.24034096e-05, 1.898649], dtype=object),
       np.array([ 1.42153214e-07, -2.93033162e-05,  1.60305995e+00])],
      dtype=object)

q_coeffs_fiber1 = np.array([np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       ...
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01]),
       np.array([8.94993664e-08, -0.000320059415, 0.797740336], dtype=object),
       np.array([8.38733107e-08, -0.000289210225, 0.762255118], dtype=object),
       np.array([1.28920178e-07, -0.000392561753, 0.819761528], dtype=object),
       np.array([7.89358672e-08, -0.000297021332, 0.786529869], dtype=object),
       np.array([7.25688631e-08, -0.000302269797, 0.800805653], dtype=object),
       np.array([1.32694971e-07, -0.000404525811, 0.825495446], dtype=object),
       np.array([1.39918679e-07, -0.000377843286, 0.787431458], dtype=object),
       np.array([3.5861227e-08, -0.000153556004, 0.684387258], dtype=object),
       np.array([2.24269843e-08, -0.000148593195, 0.698198157], dtype=object),
       np.array([4.15834113e-08, -0.000180849611, 0.707522965], dtype=object),
       np.array([-1.48791371e-08, -0.000166429985, 0.713326854], dtype=object),
       np.array([1.50242489e-07, -0.000368407115, 0.767013528], dtype=object),
       np.array([1.43332271e-07, -0.000344327028, 0.754940232], dtype=object),
       np.array([1.23235496e-07, -0.000307248658, 0.755636648], dtype=object),
       np.array([1.65587309e-07, -0.000404185585, 0.808619093], dtype=object),
       np.array([8.80399936e-08, -0.000212431257, 0.701332968], dtype=object),
       np.array([8.16763445e-08, -0.000193522978, 0.701152982], dtype=object),
       np.array([8.95938293e-09, -6.35913125e-05, 0.661521585], dtype=object),
       np.array([5.6154637e-08, -0.000186291868, 0.722930646], dtype=object),
       np.array([6.53123797e-08, -0.000151719828, 0.703369417], dtype=object),
       np.array([6.18484254e-08, -0.000135954787, 0.700907514], dtype=object),
       np.array([ 8.36091642e-08, -2.57171468e-04,  7.45756155e-01])],
      dtype=object)


theta_coeffs_fiber1 = np.array([np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       ...
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01]),
       np.array([-3.22168476e-11, 1.72271252e-07, -0.000346907422, 1.53593693],
             dtype=object)                                                  ,
       np.array([-1.06914887e-10, 4.45445781e-07, -0.000637628487, 1.44805445],
             dtype=object)                                                  ,
       np.array([1.54875756e-11, -1.6117382e-08, -5.60985934e-05, 1.17889062],
             dtype=object)                                                 ,
       np.array([1.22098218e-10, -4.0593969e-07, 0.000238987148, 1.12780102],
             dtype=object)                                                ,
       np.array([1.35821429e-10, -5.3893383e-07, 0.000603665171, 0.805144867],
             dtype=object)                                                 ,
       np.array([2.52749929e-10, -9.75618309e-07, 0.00113730812, 0.555066844],
             dtype=object)                                                 ,
       np.array([3.54649911e-10, -1.34445673e-06, 0.00152959726, 0.423850646],
             dtype=object)                                                 ,
       np.array([6.91512181e-11, -3.39138305e-07, 0.000503846507, 0.677477138],
             dtype=object)                                                  ,
       np.array([9.15745762e-11, -4.63567301e-07, 0.000692788196, 0.588540729],
             dtype=object)                                                  ,
       np.array([1.12801388e-10, -5.56210976e-07, 0.000851860784, 0.498105746],
             dtype=object)                                                  ,
       np.array([1.50253653e-10, -6.96914097e-07, 0.00103150212, 0.404811512],
             dtype=object)                                                 ,
       np.array([2.6938255e-10, -1.05609689e-06, 0.00128040602, 0.437280555],
             dtype=object)                                                ,
       np.array([2.35667037e-10, -9.3613006e-07, 0.00115293015, 0.473141316],
             dtype=object)                                                ,
       np.array([2.36623113e-10, -9.07605389e-07, 0.00110198715, 0.509230369],
             dtype=object)                                                 ,
       np.array([4.29360698e-10, -1.47520808e-06, 0.00133817462, 0.820557714],
             dtype=object)                                                 ,
       np.array([2.33777632e-10, -8.55957761e-07, 0.000926418486, 0.637750485],
             dtype=object)                                                  ,
       np.array([1.52454313e-10, -5.50010136e-07, 0.000619188705, 0.695534164],
             dtype=object)                                                  ,
       np.array([9.18834584e-12, -6.65789505e-08, 0.000170552482, 0.802883431],
             dtype=object)                                                  ,
       np.array([1.03533981e-10, -4.10145737e-07, 0.000489571959, 0.827029241],
             dtype=object)                                                  ,
       np.array([-7.48995412e-13, 1.07834799e-07, -0.000296749832, 1.09985808],
             dtype=object)                                                  ,
       np.array([-5.60297787e-11, 3.49206034e-07, -0.000629501952, 1.2665733],
             dtype=object)                                                 ,
       np.array([ 1.32317384e-10, -5.00946274e-07,  5.57233266e-04,  8.00643769e-01])],
      dtype=object)
