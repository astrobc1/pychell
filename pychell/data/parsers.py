...
class DataParser:
    ...
    def compute_barycenter_corrections(self, data, target=None):
        ...
        # BJD
        data.bjd = JDUTC_to_BJDTDB(JDUTC=jdmid, starname=target, obsname=self.specmod.observatory['name'], leap_update=False)[0][0]
        
        # bc vel
        data.bc_vel = get_BC_vel(JDUTC=jdmid, starname=target, obsname=self.specmod.observatory['name'], leap_update=False)[0][0]
