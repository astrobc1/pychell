...
forward_model_blueprints = {
    ...
    'blaze': {
        ...
        # This needs changed for the simulation
    ...
    'lsf': {
        ...
        # get LSF in pixels from email from Rose, and translate.
    ...
    'wavelength_solution': {
        ...
        'n_splines': 0,
        'n_delay_splines': 0, # irrelevant
        'spline': [-0.15, 0.01, 0.15] # not used
    }
}